...
[Azure IoT Hub](https://azure.microsoft.com/documentation/articles/iot-hub-what-is-iot-hub/?WT.mc_id=iot-0000-dglover) over a secure [MQTT](https://azure.microsoft.com/documentation/articles/iot-hub-mqtt-support/?WT.mc_id=iot-0000-dglover) connection from ESP8266 MCUs.
...
[Arduino core for ESP8266 WiFi chip V2.3](https://github.com/esp8266/Arduino) firmware adds ([TLS](http://axtls.sourceforge.net/) 1.0 and 1.1) support, making this a viable platform for secure IoT data streaming. See [Security Discussion](https://github.com/esp8266/Arduino/issues/43) for more information.
...
Right mouse click the device you setup in Device Explorer to obtain connection string information.
